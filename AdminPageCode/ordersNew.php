                                    ...
                                    while ($user = mysqli_fetch_object($user_query)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p id='c<?= $order->orderId ?>'><?php echo (json_decode($order->delivered)) ? '' : '<button class="btn btn-danger mb-1" onclick="cancel(' . $order->orderId . ')">Cancel Order</button>' ?></p>
                                            </td>
                                        </tr>
                                <?php }
                                } ?>
...
<script>
    ...
    function cancel(id) {
        if (confirm("Are You Sure You Want To Cancel This Order")) {
            window.location = `ordersNew.php?dorder=${id}`;
        } else {
            console.log("no")
        }
    }
