...
if (isset($_POST['checkout'])) {
    ...
    $products = json_decode($productQuantity);//decoding from cart(1.....5 only)
...
?>
    ...
    <div class="container mt-4">
        <div id="printableArea" class="card mx-auto p-4 w-75">
            <div class="row">
                <div class="col-6 me-auto">
                    <h1>Sendriya Farming</h1>
                    <h4>Company Address:<span> 406 sendriya at satara 415013</span></h4>
                    <h4>Phone Number:<span>84199 44604</span></h4>
                    <h4>Email Id:<span>omkarnipane01@gmail.com</span></h4>
                </div>
            </div>
            <div class="row mt-4">
        ...
        <button type="button" class="btn btn-primary" onclick="printDiv('printableArea')">Print</button>
                        <button type="button"  class="btn btn-success"><a href="ordersWC.php">Go to Orders</button></a>
